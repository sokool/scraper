...
func main() {
	...
	config := thief.Config("/home/sokool/IdeaProjects/go/src/github.com/sokool/scraper/config.json")
	//console.Log(config.Url())
	//console.Log(config.Root())
	console.Log(config)
	//console.Log(config)
	//console.Log(config.NodeNeighbors("documents"))
...
return
	...
	homegate := thief.NewScheme("xml", link, "cantons").
